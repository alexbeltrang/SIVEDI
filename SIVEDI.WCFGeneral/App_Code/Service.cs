...
//private DataTable getDatosCadenaConexion(string KeyPath)
//{
//    DataTable dttTemp = new DataTable();
//    DataRow row;
//    {
//        var withBlock = dttTemp;
//        withBlock.Columns.Add(new DataColumn("DATABASE", typeof(string)));
//        withBlock.Columns.Add(new DataColumn("PASSWORD", typeof(string)));
//        withBlock.Columns.Add(new DataColumn("USER", typeof(string)));
//        withBlock.Columns.Add(new DataColumn("SERVER", typeof(string)));
//        withBlock.Columns.Add(new DataColumn("CONNECTTIMEOUT", typeof(string)));
//        withBlock.Columns.Add(new DataColumn("ALIAS", typeof(string)));
//    }
//    row = dttTemp.NewRow();
//    RegistryKey key = Registry.CurrentUser.OpenSubKey(KeyPath, false); // Abrimos para sólo lectura
//    if (key != null)
//    {
//        string[] values = key.GetValueNames(); // Obtenemos los nombres de todos los valores en la key
//        foreach (string value in values)
//        {
//            if (value == "ServerSales")
//                row["SERVER"] = key.GetValue(value);
//            else if (value == "DBUserSales")
//                row["USER"] = key.GetValue(value);
//            else if (value == "DBPasswordSales")
//                row["PASSWORD"] = key.GetValue(value);
//            else if (value == "DatabaseSales")
//                row["DATABASE"] = key.GetValue(value);
//            else if (value == "connect timeout")
//                row["CONNECTTIMEOUT"] = key.GetValue(value);
//            else if (value == "Alias")
//                row["ALIAS"] = key.GetValue(value);
//        }
//        dttTemp.Rows.Add(row);
//    }
//    return dttTemp;
//}
